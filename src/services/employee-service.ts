...
export default class EmployeeService {
  ...
  static async getProfile(id?: string | number) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/profile-view/${id}`
    )
    return res
  }
  ...
  static async getOverView(id?: string | number) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/overview/${id}`
    )
    return res
  }
  static async getAllDocuments(id?: string | number) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/documents/all/${id}`
    )
    return res
  }
  static async getSalary(id?: string | number) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/salary-information/${id}`
    )
    return res
  }
  static async getGenders() {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[1]}/profile-setting/`
    )
    return res
  }
  static async getDepartments() {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[1]}/department-setting`
    )
    return res
  }
  static async getOnlyEmployees(params?: any) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/get-employee-Only-name/`,
      {
        params,
      }
    )
  ...
  static async getOnlyEmployeesWithoutSelf(params?: any) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[0]}/get-employee-Only-name-self/`,
      {
        params,
      }
    )
  ...
  static async getDesignation(id?: string | number) {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[1]}/designation-setting/${id}`
    )
    return res
  }
  static async getLeaves() {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[1]}/leave-setting`
    )
    return res
  }
  static async getAllowence() {
    const res = await ApiService.get(
      `${EmployeeService.baseUrl[1]}/allownce-setting/`
    )
    return res
  }
  ...
  static async addEmployee(data: any) {
    const res = await ApiService.post(
      `${EmployeeService.baseUrl[0]}/personal-information`,
      data
    )
    return res
  }
  static async addCompany(data: any) {
    const res = await ApiService.post(
      `${EmployeeService.baseUrl[0]}/company-information`,
      data
    )
    return res
  }
  ...
  static async deleteDocument(id: string | number) {
    const res = await ApiService.delete(
      `${EmployeeService.baseUrl[0]}/documents/${id}`
    )
    return res
  }
  ...
  static async addDocument(data: any) {
    const res = await ApiService.post(
      `${EmployeeService.baseUrl[0]}/documents`,
      data
    )
    return res
  }
